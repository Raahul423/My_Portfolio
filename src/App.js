    ...
    <div className="App">
      ...
      <section id="profile">
        <div className="section__pic-container">
          <img src={profile} alt="Rahul Pal profile" />
        </div>
      ...
      <section id="about">
        ...
        <div className="section-container">
          <div className="section__pic-container">
            <img src={images} alt="Profile" className="about-pic" />
          </div>
          ...
          <div className="about-containers">
            <div className="details-container     color-container">
              ...
              <div className="btn-container">
                ...
                <button className="btn btn-color-2 project-btn" onClick={() => window.location.href='https://raahul423.github.io/YouTube-Clone/'}>
                  Live Demo
                </button>
              </div>
            </div>
